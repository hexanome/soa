...
\usepackage{eurosym}
% Utilisation du package float pour les alignements de figures.
\usepackage{float}
% Captions avancées.
\usepackage{caption}
...
\lhead{H4111}
\lfoot{H4111}
\chead{Compte Rendu} %% <------- CHANGE ICI!!
\cfoot{Compte Rendu} %% <------- CHANGE ICI!!
\rhead{Mars 2012}
...
\vfill
	\begin{center}
		\begin{Huge}
		Projet Système d'Information Urbanisé \& SOA : Compte Rendu\\ %% <------- CHANGE ICI!!
		\end{Huge} 
\vfill
		\textbf{Hexanome 4111 :} 
...
\input{./conception-ensemble.tex}
\input{./conception-detaillee.tex}
