...
\lhead{H4111}
\lfoot{H4111}
\chead{Dossier d'Initialisation} %% <------- CHANGE ICI!!
\cfoot{Dossier d'Initialisation} %% <------- CHANGE ICI!!
\rhead{Mars 2012}
...
\vfill
	\begin{center}
		\begin{Huge}
		Projet Système d'Information Urbanisé \& SOA : Dossier d'Initialisation\\ %% <------- CHANGE ICI!!
		\end{Huge} 
\vfill
		\textbf{Hexanome 4111 :} 
